  ...
  return (
    <Context value={toggled}>
      <div className=' top-0 left-0 w-full'>
        <nav className="bg-primary w-full text-white   font-Lora lg:px-4 md:px-1 py-2 shadow-lg hover:bg-white hover:text-dark h-fit z-100 select-none">
        ...
        <CategoryBar name='Read' reversed={true}/>
      </div>
      {toggle && <SideBar />}
    </Context>
  )
